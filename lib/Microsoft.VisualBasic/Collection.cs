...
// Type: Microsoft.VisualBasic.Collection
...
namespace Microsoft.VisualBasic
{
    ...
    public sealed class Collection : ICollection, IList, ISerializable, IDeserializationCallback
    {
        ...
        {
            if (Key == null)
                throw new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(Key)));
            ...
            get
            {
                switch (Index)
                {
                    ...
                    default:
                        ...
                        {
                            throw new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(Index)));
                        }
                        return this[integer];
                }
            }
        ...
        private void AdjustEnumeratorsHelper(
          Collection.Node NewOrRemovedNode,
          ForEachEnum.AdjustIndexType Type)
        {
            int index = checked(this.m_Iterators.Count - 1);
            while (index >= 0)
            {
        ...
        {
            if (array == null)
                throw new ArgumentNullException(Utils.GetResourceString("Argument_InvalidNullValue1", nameof(array)));
            if (array.Rank != 1)
                throw new ArgumentException(Utils.GetResourceString("Argument_RankEQOne1", nameof(array)));
        ...
        private sealed class FastList
        {
            ...
            private bool DataIsEqual(object obj1, object obj2)
            {
                if (obj1 == obj2)
                    return true;
                return obj1.GetType() == obj2.GetType() && object.Equals(obj1, obj2);
            }
            ...
            private void Insert(
              ...
              Collection.Node PrevNode,
              Collection.Node CurrentNode)
            {
