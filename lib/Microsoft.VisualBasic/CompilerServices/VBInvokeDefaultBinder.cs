...
// Type: Microsoft.VisualBasic.CompilerServices.VBInvokeDefaultBinder
...
namespace Microsoft.VisualBasic.CompilerServices
{
  internal class VBInvokeDefaultBinder : InvokeBinder
  {
      ...
      DynamicMetaObject errorSuggestion)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Expression right = (Expression) Expression.Call(typeof (NewLateBinding).GetMethod("FallbackInvokeDefault1"), target.Expression, (Expression) Expression.Assign((Expression) array, (Expression) Expression.NewArrayInit(typeof (object), args)), (Expression) Expression.Constant((object) argNames, typeof (string[])), (Expression) Expression.Constant((object) this._reportErrors));
    ...
    {
      return _other is VBInvokeDefaultBinder invokeDefaultBinder && this.CallInfo.Equals((object) invokeDefaultBinder.CallInfo) && this._reportErrors == invokeDefaultBinder._reportErrors;
    }

    public override int GetHashCode()
    {
      return VBInvokeDefaultBinder.s_hash ^ this.CallInfo.GetHashCode() ^ this._reportErrors.GetHashCode();
    }
  }
}
