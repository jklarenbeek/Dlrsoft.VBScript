...
// Type: Microsoft.VisualBasic.CompilerServices.VBInvokeBinder
...
namespace Microsoft.VisualBasic.CompilerServices
{
  internal class VBInvokeBinder : InvokeBinder
  {
      ...
      DynamicMetaObject errorSuggestion)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Expression right = (Expression) Expression.Call(typeof (NewLateBinding).GetMethod(this._lateCall ? "LateCallInvokeDefault" : "LateGetInvokeDefault"), target.Expression, (Expression) Expression.Assign((Expression) array, (Expression) Expression.NewArrayInit(typeof (object), args)), (Expression) Expression.Constant((object) argNames, typeof (string[])), (Expression) Expression.Constant((object) this._lateCall));
    ...
    {
      return _other is VBInvokeBinder vbInvokeBinder && this.CallInfo.Equals((object) vbInvokeBinder.CallInfo) && this._lateCall.Equals(vbInvokeBinder._lateCall);
    }

    public override int GetHashCode()
    {
      return VBInvokeBinder.s_hash ^ this.CallInfo.GetHashCode() ^ this._lateCall.GetHashCode();
    }
  }
}
