...
// Type: Microsoft.VisualBasic.DateAndTime
...
namespace Microsoft.VisualBasic
{
    ...
    public sealed class DateAndTime
    {
        ...
        public static string DateString
        {
            get
            {
                return DateAndTime.IsDBCSCulture() ? DateTime.Today.ToString("yyyy\\-MM\\-dd", (IFormatProvider)Utils.GetInvariantCultureInfo()) : DateTime.Today.ToString("MM\\-dd\\-yyyy", (IFormatProvider)Utils.GetInvariantCultureInfo());
            }
        }
          ...
          DateTime DateValue)
        {
            ...
            switch (Interval)
            {
                ...
                default:
                    throw new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(Interval)));
            }
        }
        ...
        public static int DatePart(
          DateInterval Interval,
          DateTime DateValue,
          FirstDayOfWeek FirstDayOfWeekValue = FirstDayOfWeek.Sunday,
          FirstWeekOfYear FirstWeekOfYearValue = FirstWeekOfYear.Jan1)
        {
            switch (Interval)
            {
                case DateInterval.Year:
        ...
        public static DateTime DateAdd(string Interval, double Number, object DateValue)
        {
            ...
            {
                throw new InvalidCastException(Utils.GetResourceString("Argument_InvalidDateValue1", nameof(DateValue)));
            }
          ...
          FirstWeekOfYear WeekOfYear = FirstWeekOfYear.Jan1)
        {
            ...
            {
                throw new InvalidCastException(Utils.GetResourceString("Argument_InvalidDateValue1", nameof(Date1)));
            }
            DateTime date2;
            try
            {
            ...
            {
                throw new InvalidCastException(Utils.GetResourceString("Argument_InvalidDateValue1", nameof(Date2)));
            }
        ...
        public static DateTime DateSerial(int Year, int Month, int Day)
        {
            ...
            {
                throw ExceptionUtils.VbMakeException((Exception)new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(Year))), 5);
            }
            DateTime time;
            try
            {
            ...
            {
                throw ExceptionUtils.VbMakeException((Exception)new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(Month))), 5);
            }
            try
            {
            ...
            {
                throw ExceptionUtils.VbMakeException((Exception)new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(Day))), 5);
            }
        }
        ...
        public static int Weekday(DateTime DateValue, FirstDayOfWeek DayOfWeek = FirstDayOfWeek.Sunday)
        {
            switch (DayOfWeek)
            {
                case FirstDayOfWeek.System:
                    ...
                    goto case FirstDayOfWeek.Sunday;
                ...
                default:
                    throw new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(DayOfWeek)));
            }
        }

        /// <summary>Returns a string value containing the name of the specified month.</summary>
        /// <param name="Month">Required. The numeric designation of the month, from 1 through 13; 1 indicates January and 12 indicates December. You can use the value 13 with a 13-month calendar. If your system is using a 12-month calendar and <paramref name="Month" /> is 13, MonthName returns an empty string.</param>
        ...
        {
            if (Month < 1 || Month > 13)
                throw new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(Month)));
        ...
        public static string WeekdayName(
          ...
          FirstDayOfWeek FirstDayOfWeekValue = FirstDayOfWeek.System)
        {
            if (Weekday < 1 || Weekday > 7)
                throw new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(Weekday)));
            if (FirstDayOfWeekValue < FirstDayOfWeek.System || FirstDayOfWeekValue > FirstDayOfWeek.Saturday)
                throw new ArgumentException(Utils.GetResourceString("Argument_InvalidValue1", nameof(FirstDayOfWeekValue)));
